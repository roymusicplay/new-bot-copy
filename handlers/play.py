...
@Client.on_message(command("rani") 
                   & filters.group
                   & ~filters.edited 
                   & ~filters.forwarded
                   & ~filters.via_bot)
async def play(_, message: Message):
    ...
    lel = await message.reply("🔄 **load best 👌 quality ❤️ song 🎶**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit(
                        "<b>𝗔𝗱 𝗠𝗲 𝗔𝘀 𝗔𝗱𝗺𝗶𝗻 𝗢𝗳 𝗬𝗼𝘂𝗿 𝗚𝗿𝘂𝗼𝗽  𝗙𝗶𝗿𝘀𝘁 ❰ @abhinasroy ❱</b>")
                    return
    ...
    if audio:
            ...
            [
                [
                    InlineKeyboardButton(
                            text="𝐂𝐡𝐚𝐧𝐧𝐞𝐥📡",
                            url=f"https://t.me/ABOUT_ABHINAS"),
                        InlineKeyboardButton(
                            text="𝐆𝐫𝐨𝐮𝐩⭐",
                            url=f"https://t.me/DOSTI_GROUP_1234")
        ...
        await lel.edit("🔎 **𝗙𝗶𝗻𝗱𝗶𝗻𝗴  𝗧𝗵𝗲 𝗦𝗼𝗻𝗴  ❰𝗲𝗦𝗽𝗼𝗿𝘁 ❱...**")
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption="**❰music ❘ Abhinas❱ 𝗦𝗼𝗻𝗴  𝗣𝗼𝘀𝗶𝘁𝗶𝗼𝗻** {}".format(
        position
        ),
